...
- **[Working with AO via MCP Tools](agents.md)** -- Complete guide to all 75 MCP tools: JSON examples, common workflows, sequencing tips, pagination, and batch operations.
